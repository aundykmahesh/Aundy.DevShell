...
$script:PromptRefreshLocation = $null
$script:PromptRefreshGlobalJsonSignature = $null
$script:PromptRefreshLastContext = $null
$script:PromptRefreshNextUtc = [datetime]::MinValue
